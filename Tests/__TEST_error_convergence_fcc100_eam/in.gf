...
#variable        rcut equal 3.0 # between 2nd and 3rd
...
# Debug dump output
dump            debug all nc 1 traj_gf.nc type x y z fx fy fz

# Bottom row of atoms is GFMD layer
fix             gfmd bottom gfmd gfmd ft fcc100 ${d0} 4 eam/fd height ${height} reset_xeq reset_map
#fix             gfmd bottom gfmd gfmd ft fcc100 ${d0} 4 lj/cut height ${height} reset_xeq reset_map
