...
PairEAMAlloyGF::PairEAMAlloyGF(LAMMPS *lmp) : PairEAMAlloy(lmp)
{
}

PairEAMAlloyGF::~PairEAMAlloyGF()
{
}

/* ---------------------------------------------------------------------- */
/* This is an exact copy of PairEAMGF::compute() from pair_eam_gf.cpp     */
/* ---------------------------------------------------------------------- */

void PairEAMAlloyGF::compute(int eflag, int vflag)
{
